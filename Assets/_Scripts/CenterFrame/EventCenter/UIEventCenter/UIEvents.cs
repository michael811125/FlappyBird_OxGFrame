...
public class EDescriptionUI : EventBase
{
    ...
    {
        Logging.Print<MLogger>($"<color=#FFC078>【Handle Event】 -> {nameof(EDescriptionUI)}</color>");
...
public class EDoubleCheckUI : EventBase
{
    ...
    public async override UniTaskVoid HandleEvent()
    {
        Logging.Print<MLogger>($"<color=#FFC078>【Handle Event】 -> {nameof(EDoubleCheckUI)}</color>");
